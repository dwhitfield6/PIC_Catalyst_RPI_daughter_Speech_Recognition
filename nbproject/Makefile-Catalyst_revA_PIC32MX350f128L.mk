...
SOURCEFILES_QUOTED_IF_SPACED=CONFIGURATION.c main.c SYSTEM.c EXCEPTIONS.c INTERRUPTS.c USER.c MISC.c DMA.c UART.c ADC.c TIMERS.c PWM.c FLASH.c POWER.c SPI.c RDI.c RTCC.c I2C.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/CONFIGURATION.o ${OBJECTDIR}/main.o ${OBJECTDIR}/SYSTEM.o ${OBJECTDIR}/EXCEPTIONS.o ${OBJECTDIR}/INTERRUPTS.o ${OBJECTDIR}/USER.o ${OBJECTDIR}/MISC.o ${OBJECTDIR}/DMA.o ${OBJECTDIR}/UART.o ${OBJECTDIR}/ADC.o ${OBJECTDIR}/TIMERS.o ${OBJECTDIR}/PWM.o ${OBJECTDIR}/FLASH.o ${OBJECTDIR}/POWER.o ${OBJECTDIR}/SPI.o ${OBJECTDIR}/RDI.o ${OBJECTDIR}/RTCC.o ${OBJECTDIR}/I2C.o
...
# Source Files
SOURCEFILES=CONFIGURATION.c main.c SYSTEM.c EXCEPTIONS.c INTERRUPTS.c USER.c MISC.c DMA.c UART.c ADC.c TIMERS.c PWM.c FLASH.c POWER.c SPI.c RDI.c RTCC.c I2C.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/PIC_Catalyst_RPI_daughter_Speech_Recognition.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/PIC_Catalyst_RPI_daughter_Speech_Recognition.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
