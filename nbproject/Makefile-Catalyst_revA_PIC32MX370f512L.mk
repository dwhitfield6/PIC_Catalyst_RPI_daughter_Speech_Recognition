...
ifeq "$(wildcard nbproject/Makefile-local-Catalyst_revA_PIC32MX370f512L.mk)" "nbproject/Makefile-local-Catalyst_revA_PIC32MX370f512L.mk"
include nbproject/Makefile-local-Catalyst_revA_PIC32MX370f512L.mk
endif
endif
...
# Macros
CND_CONF=Catalyst_revA_PIC32MX370f512L
...
SOURCEFILES_QUOTED_IF_SPACED=CONFIGURATION.c main.c SYSTEM.c EXCEPTIONS.c INTERRUPTS.c USER.c MISC.c DMA.c UART.c ADC.c TIMERS.c PWM.c FLASH.c POWER.c SPI.c RTCC.c I2C.c EXPAND_RF.c EXPAND_IR.c CMD.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/CONFIGURATION.o ${OBJECTDIR}/main.o ${OBJECTDIR}/SYSTEM.o ${OBJECTDIR}/EXCEPTIONS.o ${OBJECTDIR}/INTERRUPTS.o ${OBJECTDIR}/USER.o ${OBJECTDIR}/MISC.o ${OBJECTDIR}/DMA.o ${OBJECTDIR}/UART.o ${OBJECTDIR}/ADC.o ${OBJECTDIR}/TIMERS.o ${OBJECTDIR}/PWM.o ${OBJECTDIR}/FLASH.o ${OBJECTDIR}/POWER.o ${OBJECTDIR}/SPI.o ${OBJECTDIR}/RTCC.o ${OBJECTDIR}/I2C.o ${OBJECTDIR}/EXPAND_RF.o ${OBJECTDIR}/EXPAND_IR.o ${OBJECTDIR}/CMD.o
...
# Source Files
SOURCEFILES=CONFIGURATION.c main.c SYSTEM.c EXCEPTIONS.c INTERRUPTS.c USER.c MISC.c DMA.c UART.c ADC.c TIMERS.c PWM.c FLASH.c POWER.c SPI.c RTCC.c I2C.c EXPAND_RF.c EXPAND_IR.c CMD.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-Catalyst_revA_PIC32MX370f512L.mk dist/${CND_CONF}/${IMAGE_TYPE}/PIC_Catalyst_RPI_daughter_Speech_Recognition.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/CMD.o: CMD.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/CMD.o 
	@${FIXDEPS} "${OBJECTDIR}/CMD.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/CMD.o.d" -o ${OBJECTDIR}/CMD.o CMD.c     
...
dist/${CND_CONF}/${IMAGE_TYPE}/PIC_Catalyst_RPI_daughter_Speech_Recognition.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/PIC_Catalyst_RPI_daughter_Speech_Recognition.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}              -mreserve=boot@0x1FC02000:0x1FC02FEF -mreserve=boot@0x1FC02000:0x1FC0275F  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Catalyst_revA_PIC32MX370f512L
	${RM} -r dist/Catalyst_revA_PIC32MX370f512L
